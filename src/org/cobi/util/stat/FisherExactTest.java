...
public class FisherExactTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int B = 1; B < 10; B++) {
            ...
            counts[1][0] = C;
            counts[1][1] = D;
            System.out.println(B + " " + FisherExactTest.contigencyTable22(counts, 2));
        }
    }
    ...
    static public double contigencyTable22(long[][] contigencyTable22, int tails) {
        ...
        if (tails == 2) {
            ...
            return Math.min(tail1DownP, tail1UpP);
        } else {
            return tail2P;
        }
